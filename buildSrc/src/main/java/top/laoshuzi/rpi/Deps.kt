...
public object Deps {
    ...
    public object kotlin {
        public object stdlib {
            public const val it = "org.jetbrains.kotlin:kotlin-stdlib:${Versions.kotlin}"
    ...
    public object kotlinx {
        public object coroutines {
            public const val it = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Versions.kotlinx_coroutines}"
        ...
        public object serialization_runtime {
            public const val it = "org.jetbrains.kotlinx:kotlinx-serialization-runtime:${Versions.kotlinx_serialization_runtime}"
    ...
    public object ktor {
        public const val it = "io.ktor:ktor-client-core:${Versions.ktor}"
